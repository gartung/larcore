...
$APAHeight[0] = $TPCLargestShortDrift_y;
$APAHeight[1] = $TPCMidShortDrift_y;
$APAHeight[2] = $TPCSmallestShortDrift_y;

# The following are "for-now" dimensions
$nPaddlesInAPA[0] = 9;
$nPaddlesInAPA[1] = 5;
$nPaddlesInAPA[2] = 2;
...
$LightPaddleLength = ($APA_z - 9*$inch); # $SiPM is added in the solid difinition

$PaddleYInterval[0] = $APAHeight[0] / ($nPaddlesInAPA[0] + 1 );
$PaddleYInterval[1] = $APAHeight[1] / ($nPaddlesInAPA[1] + 1 );
$PaddleYInterval[2] = $APAHeight[2] / ($nPaddlesInAPA[2] + 1 );


$FrameToPaddleSpace[0] = $LightPaddleHeight/2 + $PaddleYInterval[0]/2 + 2*$inch;
$FrameToPaddleSpace[1] = $LightPaddleHeight/2 + $PaddleYInterval[1]/2 + 2*$inch;
$FrameToPaddleSpace[2] = $LightPaddleHeight/2 + $PaddleYInterval[2]/2 + 2*$inch;

# z and x are given by APA frame center.
#  Get y distance of each paddle from the  
#  bottom of the APA to the paddle y-center.
# To be used in make_APA

$PaddleYPositions[0][0] = $FrameToPaddleSpace[0];
$PaddleYPositions[1][0] = $FrameToPaddleSpace[1];
$PaddleYPositions[2][0] = $FrameToPaddleSpace[2];

for( $apa=0; $apa<3; $apa++ ){
    for( $i=1; $i<$nPaddlesInAPA[0]; $i++  ){
	$PaddleYPositions[$apa][$i] = $PaddleYPositions[$apa][$i-1] + $PaddleYInterval[$apa];
    }
}
...
$SpaceCPAToCryoWall    =    20; #$SideLArPadding
$SpaceAPAToFloor       =    20; #$BottomLArPadding
$SpaceAPAToTopLAr      =    20; #$TopLArPadding
$HeightGaseousAr       =    20; #$Height of Gaseous Ar region
$UpstreamLArPadding    =    20;
$DownstreamLArPadding  =    20;
...
$Argon_y	       =    $TPCSmallestShortDrift_y 
                          + $APAVerticalGap 
                          + $TPCMidShortDrift_y
                          + $SpaceAPAToFloor 
                          + $SpaceAPAToTopLAr
                          + $HeightGaseousAr; 
$Argon_z	       =    2*$TPCLargestShortDrift_z 
                          + $APALongGap
                          + $UpstreamLArPadding 
...
$DetEnc_y	       =    $Cryostat_y+2*$TotalPadding;
...
$OriginZSet             =       $DetEnc_z/2 
  ...
  # TODO: change total padding here to concrete padding, and arrange foam/concrete volumes
...
$World_x  = 3*$RockThickness;
$World_y = 3*$RockThickness;
$World_z = 3*$RockThickness;
...
$posTPCsld_y  =  - $Argon_y/2
                 + $SpaceAPAToFloor
                 + $TPCSmallestLongDrift_y/2;  
$posTPCsld_z  =    $Argon_z/2
                 - $DownstreamLArPadding
                 - $TPCSmallestLongDrift_z/2;
...
$posTPClld_z  =  - $Argon_z/2
                 + $UpstreamLArPadding
                 + $TPCLargestLongDrift_z/2;
...
$posTPCssd_y  =  - $Argon_y/2
                 + $SpaceAPAToFloor
                 + $TPCSmallestShortDrift_y/2; 
$posTPCssd_z  =    $Argon_z/2
                 - $DownstreamLArPadding
                 - $TPCSmallestShortDrift_z/2; 
...
$posTPCmsd_y  =    $Argon_y/2
                 - $HeightGaseousAr
                 - $SpaceAPAToTopLAr
                 - $TPCMidShortDrift_y/2; 
$posTPCmsd_z  =    $Argon_z/2
                 - $DownstreamLArPadding
                 - $TPCMidShortDrift_z/2;
...
$posTPClsd_z  =  - $Argon_z/2
                 + $UpstreamLArPadding
                 + $TPCLargestShortDrift_z/2;
...
gen_Materials(); # generates materials to be used
    ...
    gen_TPC( $TPCSmallestLongDrift_x, $TPCSmallestLongDrift_y, $TPCSmallestLongDrift_z, 'SmallestLongDrift');
    gen_TPC( $TPCMidLongDrift_x, $TPCMidLongDrift_y, $TPCMidLongDrift_z, 'MidLongDrift');
    gen_TPC( $TPCLargestLongDrift_x, $TPCLargestLongDrift_y, $TPCLargestLongDrift_z, 'LargestLongDrift');

    gen_TPC( $TPCSmallestShortDrift_x, $TPCSmallestShortDrift_y, $TPCSmallestShortDrift_z, 'SmallestShortDrift');
    gen_TPC( $TPCMidShortDrift_x, $TPCMidShortDrift_y, $TPCMidShortDrift_z, 'MidShortDrift') ;
    gen_TPC( $TPCLargestShortDrift_x, $TPCLargestShortDrift_y, $TPCLargestShortDrift_z, 'LargestShortDrift');
...
-->
   ...
   <position name="posTPCLargestShortDrift"  unit="cm" x="$posTPClsd_x" y="$posTPClsd_y" z="$posTPClsd_z"/>
   <position name="posTPCLargestLongDrift"   unit="cm" x="$posTPClld_x" y="$posTPClld_y" z="$posTPClld_z"/>
